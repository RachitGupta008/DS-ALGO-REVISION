// This is different from jump game 2 because of the path that we take will result in how much fuel we will be left at a given pt which will help us move forward

// for jump game path doesn't matter we only care of reaching the highest pt
// but here path matters, so we use heap to move back in time in order to increase fuel capacity to reach a given distance

// example [[13,21],[26,115],[100,47],[225,99],[299,141],[444,198],[608,190],[636,157],[647,255],[841,123]]
// with start fuel as 299 the path matters , if we go directly to 299 we won't have enough fuel to move forward
// so we go to 299 but we move backward with help of heap in order to increase the fuel at pt 299 to move forward.

// for this we go to 299,141
//26,115
//444,198
//647, 255
